...
import org.example.repository.batis.BatisHouseRepository;
...
@DisplayName("MyBATIS: Тестирование сервиса House")
class BatisHouseServiceTest {
    ...
    static void setUpAll() {
        BatisHouseRepository houseRepository = new BatisHouseRepository();
