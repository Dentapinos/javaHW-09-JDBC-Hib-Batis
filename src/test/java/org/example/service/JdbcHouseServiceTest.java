...
import org.example.repository.jdbc.JdbcHouseRepository;
...
@DisplayName("JDBC: Тестирование сервиса House")
class JdbcHouseServiceTest {
    ...
    static void setUpAll() {
        JdbcHouseRepository houseRepository = new JdbcHouseRepository();
