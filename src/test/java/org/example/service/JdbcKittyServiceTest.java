...
import org.example.repository.jdbc.JdbcKittyRepository;
...
@DisplayName("JDBC: Тестирование сервиса Kitty")
class JdbcKittyServiceTest {
    ...
    static void setUpAll() {
        JdbcKittyRepository kittyRepository = new JdbcKittyRepository();
