...
import org.example.repository.hibernate.HibernateKittyRepository;
...
@DisplayName("HIBERNATE: Тестирование сервиса Kitty")
class HibernateKittyServiceTest {
    ...
    static void setUpAll() {
        HibernateKittyRepository kittyRepository = new HibernateKittyRepository();
