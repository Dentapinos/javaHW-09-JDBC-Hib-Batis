...
import org.example.repository.batis.BatisMasterRepository;
...
@DisplayName("MyBATIS: Тестирование сервиса Master")
class BatisMasterServiceTest {
    ...
    static void setUpAll() {
        BatisMasterRepository masterRepository = new BatisMasterRepository();
